...
const Testimonials = () => {
  return (
    <div>
      <div className="testmain text-center container">
      <span><h4 className='text-primary'>TESTIMONIALS</h4><h1>The Trust From Clients</h1></span>
<div id="carouselMultiItemExample" class="carousel slide carousel-dark text-center py-5" data-mdb-ride="carousel">
